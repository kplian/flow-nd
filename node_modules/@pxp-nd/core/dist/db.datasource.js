...
const setConfig = (connection) => {
    ...
    if (connection.hasOwnProperty('entities')) {
        const entities = [
            ...config.entities,
            ...Object.keys(connection.entities).map((e) => connection.entities[e]),
        ];
        return Object.assign(Object.assign(Object.assign({}, config), connection), { entities, subscribers: [...subscribers, ...config.subscribers] });
    }
