...
export declare class Controller implements ControllerInterface {
    ...
    constructor(module: string, Entity?: any, config?: IConfigPxpApp);
    private initializeRoutes;
    genericMethodWrapper(params: Record<string, unknown>, req: Request, next: NextFunction, res: Response, methodName: string, dbsettings: string, readonly: boolean, permission?: boolean, log?: boolean, logConfig?: {}): Promise<void>;
    ormMethodWrapper(params: Record<string, unknown>, req: Request | any, next: NextFunction, res: Response, methodName: string, readonly: boolean, permission?: boolean, log?: boolean, logConfig?: {}): Promise<void>;
