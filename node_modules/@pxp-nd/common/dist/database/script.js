...
scriptsArray.push({
    scriptCode: 'JRR-PXP-20200601-001', scriptFunction: async (em) => {
        ...
        const subsystem = new entities_1.Subsystem();
        subsystem.name = 'PXP';
        subsystem.code = 'PXP';
